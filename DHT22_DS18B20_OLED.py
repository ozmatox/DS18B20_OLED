...
temp_sensor ='/sys/bus/w1/devices/28-0316a06bf7ff/w1_slave'
...
while True:
    ...
    draw.text((x, top), 'DS18B20 + DHT22', font=font3, fill=1)
    ...
    disp.display()
    time.sleep(5)
    print 'DHT22: {0:0.1f} C'.format(temperature, humidity), 'DHT22: {1:0.1f} %'.format(temperature, humidity), 'DS18b20:', (temperatura), 'C'
